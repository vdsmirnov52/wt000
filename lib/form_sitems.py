...
#	print "<tr><td align=right>force <td><input name='force' type='text' size=1 value='0' /></td><td> </td></tr>"
	print "<tr><td align=right>flags <td> <input name='flags' type='text' size=10 /></td><td>флаги видимости для возвращаемого результата </td></tr>"
#	print "<tr><td align=right> <td><input name='' type='text' size=10 /></td><td> </td></tr>"
	print "</table>"
	print "<div id='set_vals' style='border: 1px solid #bbc; color: #668;'>set_vals</div>"
